...
public final class MovieServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.vaibhav.grpcflix.movie.MovieSearchRequest,
      com.vaibhav.grpcflix.movie.MovieSearchResponse> getGetMoviesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getMovies",
      requestType = com.vaibhav.grpcflix.movie.MovieSearchRequest.class,
      responseType = com.vaibhav.grpcflix.movie.MovieSearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.vaibhav.grpcflix.movie.MovieSearchRequest,
      com.vaibhav.grpcflix.movie.MovieSearchResponse> getGetMoviesMethod() {
    io.grpc.MethodDescriptor<com.vaibhav.grpcflix.movie.MovieSearchRequest, com.vaibhav.grpcflix.movie.MovieSearchResponse> getGetMoviesMethod;
      ...
      synchronized (MovieServiceGrpc.class) {
        if ((getGetMoviesMethod = MovieServiceGrpc.getGetMoviesMethod) == null) {
          MovieServiceGrpc.getGetMoviesMethod = getGetMoviesMethod = 
              io.grpc.MethodDescriptor.<com.vaibhav.grpcflix.movie.MovieSearchRequest, com.vaibhav.grpcflix.movie.MovieSearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MovieService", "getMovies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.vaibhav.grpcflix.movie.MovieSearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.vaibhav.grpcflix.movie.MovieSearchResponse.getDefaultInstance()))
  ...
  public static abstract class MovieServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMovies(com.vaibhav.grpcflix.movie.MovieSearchRequest request,
        io.grpc.stub.StreamObserver<com.vaibhav.grpcflix.movie.MovieSearchResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.vaibhav.grpcflix.movie.MovieSearchRequest,
                com.vaibhav.grpcflix.movie.MovieSearchResponse>(
  ...
  public static final class MovieServiceBlockingStub extends io.grpc.stub.AbstractStub<MovieServiceBlockingStub> {
    ...
    /**
     */
    public com.vaibhav.grpcflix.movie.MovieSearchResponse getMovies(com.vaibhav.grpcflix.movie.MovieSearchRequest request) {
  ...
  public static final class MovieServiceFutureStub extends io.grpc.stub.AbstractStub<MovieServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.vaibhav.grpcflix.movie.MovieSearchResponse> getMovies(
        com.vaibhav.grpcflix.movie.MovieSearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOVIES:
          serviceImpl.getMovies((com.vaibhav.grpcflix.movie.MovieSearchRequest) request,
              (io.grpc.stub.StreamObserver<com.vaibhav.grpcflix.movie.MovieSearchResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MovieServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.vaibhav.grpcflix.movie.MovieServiceOuterClass.getDescriptor();
    }
